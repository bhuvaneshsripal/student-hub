        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[var(--blue)] to-[var(--purple)] flex items-center justify-center text-white shrink-0">
                <Bot size={20} />
              </div>
              <div>
            ...
            <div className="flex items-center justify-between gap-2 pt-5">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[var(--blue)] to-[var(--purple)] shadow-lg shadow-[var(--blue)]/25 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Get Started
              </button>
            </div>
